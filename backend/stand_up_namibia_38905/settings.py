"""
Django settings for stand_up_namibia_38905 project.
...
ROOT_URLCONF = 'stand_up_namibia_38905.urls'
...
WSGI_APPLICATION = 'stand_up_namibia_38905.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stand_up_namibia_38905 API",
    "DESCRIPTION": "API documentation for stand_up_namibia_38905 App",
    "VERSION": "v1",
}
